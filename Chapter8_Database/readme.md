...
უკვე ნახეთ როგორ არის შესაძლებელი მონაცემთა ბაზის შექმნა და Flask-ის პროექტში შემოტანა.

შემდეგ შეხვედრაზე გავმართავთ ბაზასთან სამუშაო სრულ ინტერფეისს. მანამდე [გაეცანით დოკუმენტაციას](https://flask-sqlalchemy.palletsprojects.com/en/2.x/queries/) და ეცადეთ
დამოუკიდებლად შეძლოთ SQLAlchemy-ს ინსტრუქციების გამოყენება მონაცემის წასაკითხად, განსაახლებლად ან წასაშლელად.
