...
Flask Migrate-ს გამოყენება შესაძლებელია, როგორც პროგრამულად - პითონის კოდში, ასევე ტერმინალიდან. ის გვაძლევს შესაძლებლობას შევიტანოთ ცვლილებები 
ბაზის მოდელში და მოდელში შეტანილი ცვლილებები გადავიტანოთ ბაზაზე. 
